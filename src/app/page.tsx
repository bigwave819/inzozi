...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="text-white pt-24 pb-16 px-4 sm:px-6 lg:px-8 w-full mx-auto" style={{ backgroundColor: "#2B4468" }}>
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2 space-y-6">
            <h1 className="text-4xl sm:text-5xl font-bold leading-tight">
              Building <span className="text-amber-400">Digital Futures</span> with Inzozi Labs
            </h1>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 bg-white rounded-xl">
        <div className="lg:w-1/2">
          <h2 className="text-3xl font-bold text-[#2B4468] mb-4">About Inzozi Labs</h2>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-white">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose Inzozi Labs</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">We combine technical excellence with business understanding to deliver real results.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="bg-white shadow-lg p-6 rounded-xl border border-gray-200 hover:border-amber-400 transition-all">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">Explore our range of innovative products designed to empower your business.</p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-6xl mx-auto">
          {products.map((product, index) => (
            <div key={index} className="bg-white shadow-lg rounded-2xl p-8 flex flex-col items-center text-center hover:shadow-2xl transition">
              {/* Icon in Circle */}
